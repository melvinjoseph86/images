...
# List all test
./bin/ipfailover-tests-ext list ipfailover

# Run a single test
./bin/ipfailover-tests-ext run-test "[OTP][sig-network-edge] Network_Edge Author:hongli-NonHyperShiftHOST-ConnectedOnly-Critical-41025-support to deploy ipfailover [Serial]"
